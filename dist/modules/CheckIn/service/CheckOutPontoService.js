...
class CheckOutService {
    updateCheckOut(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            baterPonto.checkOutData = (0, baterPontoValidator_1.formatDateToPTBR)(new Date());
            baterPonto.checkOutHorario = (0, baterPontoValidator_1.formatDateTimeToBrazilTimeZone)(new Date());
