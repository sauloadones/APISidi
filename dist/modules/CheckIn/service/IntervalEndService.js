...
class intervalFinalService {
    updateIntervalEnd(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            baterPonto.intervalSaidaData = (0, baterPontoValidator_1.formatDateToPTBR)(new Date());
            baterPonto.intervalSaidaHorario = (0, baterPontoValidator_1.formatDateTimeToBrazilTimeZone)(new Date());
            yield baterpontoRepository.save(baterPonto);
            return baterPonto;
        });
    }
}
exports.default = intervalFinalService;
